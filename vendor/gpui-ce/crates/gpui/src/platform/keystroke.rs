...
pub struct Keystroke {
    ...
    /// Stable physical key identity supplied by an embedding platform, when
    /// available (for example Bevy's `KeyCode`). Logical keybinding matching
    /// continues to use [`Self::key`].
    #[serde(default)]
